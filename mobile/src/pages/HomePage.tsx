            ...
            <div className="flex flex-col gap-8 pb-10">
                ...
                {loading ? (
                    <div className="grid grid-cols-2 gap-4">
                        {[1, 2, 3, 4].map((i) => (
                            <div key={i} className="bg-white rounded-3xl border border-slate-100 shadow-sm p-4 animate-pulse">
                                <div className="aspect-square bg-slate-50 rounded-2xl mb-4"></div>
                                <div className="h-4 bg-slate-50 rounded w-2/3 mb-2"></div>
                ...
                {!loading && products.length === 0 && (
                    <div className="flex flex-col items-center justify-center py-20 text-center gap-4">
                        ...
                        <p className="text-slate-400 text-sm font-medium">Aucun produit trouvé dans cette catégorie.</p>
                    </div>
                )}
            </div>
        </MainLayout>
