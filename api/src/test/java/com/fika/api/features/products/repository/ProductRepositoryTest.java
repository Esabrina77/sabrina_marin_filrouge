...
class ProductRepositoryTest {
        ...
        void setUp() {
                ...
                productRepository.saveAll(List.of(
                                Product.builder().name("Café Noir").price(new BigDecimal("2.00"))
                                                .category(Category.ENTREE).allergen(Allergen.GLUTEN)
        ...
        void findByName() {
                ...
                Page<Product> result = productRepository.findWithFilters("%caf%", null, null, null, null, null,
                                pageable);
        ...
        void findByCategory() {
                Pageable pageable = PageRequest.of(0, 10);
                Page<Product> result = productRepository.findWithFilters(null, Category.ENTREE, null, null, null, null,
                                pageable);
        ...
        @Test
        @DisplayName("Filter : Recherche par exclusion d'allergène")
        void findByExcludedAllergen() {
                Pageable pageable = PageRequest.of(0, 10);
                // On exclut le GLUTEN, on devrait avoir Salade César (LACTOSE) et Cookie
                // (ARACHIDES)
                Page<Product> result = productRepository.findWithFilters(null, null, Allergen.GLUTEN, null, null, null,
                                pageable);

                assertThat(result.getContent()).hasSize(2);
                assertThat(result.getContent()).noneMatch(p -> p.getAllergen() == Allergen.GLUTEN);
        }
        ...
        void findByPriceRange() {
                Pageable pageable = PageRequest.of(0, 10);
                Page<Product> result = productRepository.findWithFilters(null, null, null, new BigDecimal("2.00"),
        ...
        void findOnlyAvailable() {
                Pageable pageable = PageRequest.of(0, 10);
                Page<Product> result = productRepository.findWithFilters(null, null, null, null, null, true, pageable);
        ...
        void findWithMultipleFilters() {
                Pageable pageable = PageRequest.of(0, 10);
                Page<Product> result = productRepository.findWithFilters(null, Category.PLAT, null,
                                new BigDecimal("5.00"),
