...
public class UserService {
     ...
     * <p>
     * Cette méthode vérifie d'abord l'existence de l'utilisateur. Si l'email est modifié,
     ...
     * @throws EmailAlreadyExistsException Si le nouvel email est déjà attribué à un autre utilisateur.
     */
    @Transactional
     ...
     * @throws UserNotFoundException Si l'utilisateur n'existe pas, empêchant la suppression.
     */
